...
/** Official LinkedIn off-site share entrypoint (not /feed/?shareActive=…, which often fails or drops the URL). */
function linkedInShareUrl(pageUrl: string): string {
  return `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(pageUrl)}`;
}

export default function BadgeShareButton({ badgePageUrl, caption }: BadgeShareButtonProps) {
  const shareHref = linkedInShareUrl(badgePageUrl);
