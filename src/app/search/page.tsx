          ...
          {loading ? (
            ...
            <div className="bg-gray-50 rounded-lg p-8 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                ...
                <Link href="/campuses" className="btn-secondary text-sm">
                  Browse campuses
                </Link>
                <Link href="/" className="text-[#991b1b] text-sm hover:underline flex items-center">
            ...
            <>
              {results.map((result) => (
                <Link
                  key={result.id}
                  href={result.campusSlug ? `/campus/${result.campusSlug}/article/${result.slug || result.id}` : `/article/${result.slug || result.id}`}
